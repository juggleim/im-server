...
community engagement, new Issues, and new pull requests. GitHub traffic is a rolling window, so
retain each local snapshot rather than expecting the API to provide long-term history.
