...
var file_commons_pbdefines_rtcroom_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x65, 0x52, 0x06, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x89, 0x01, 0x0a, 0x0c,
	...
	0x6d, 0x52, 0x04, 0x72, 0x6f, 0x6f, 0x6d, 0x22, 0x6e, 0x0a, 0x0c, 0x52, 0x74, 0x63, 0x49, 0x6e,
	0x76, 0x69, 0x74, 0x65, 0x52, 0x65, 0x71, 0x12, 0x1c, 0x0a, 0x09, 0x74, 0x61, 0x72, 0x67, 0x65,
	0x74, 0x49, 0x64, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x09, 0x74, 0x61, 0x72, 0x67,
	0x65, 0x74, 0x49, 0x64, 0x73, 0x12, 0x28, 0x0a, 0x08, 0x72, 0x6f, 0x6f, 0x6d, 0x54, 0x79, 0x70,
	...
	0x06, 0x72, 0x6f, 0x6f, 0x6d, 0x49, 0x64, 0x22, 0x36, 0x0a, 0x0e, 0x52, 0x74, 0x63, 0x4d, 0x65,
	0x6d, 0x62, 0x65, 0x72, 0x52, 0x6f, 0x6f, 0x6d, 0x73, 0x12, 0x24, 0x0a, 0x05, 0x72, 0x6f, 0x6f,
	0x6d, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x52, 0x74, 0x63, 0x4d, 0x65,
	0x6d, 0x62, 0x65, 0x72, 0x52, 0x6f, 0x6f, 0x6d, 0x52, 0x05, 0x72, 0x6f, 0x6f, 0x6d, 0x73, 0x22,
	0x99, 0x01, 0x0a, 0x0d, 0x52, 0x74, 0x63, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x52, 0x6f, 0x6f,
	...
	0x77, 0x6e, 0x65, 0x72, 0x12, 0x25, 0x0a, 0x08, 0x72, 0x74, 0x63, 0x53, 0x74, 0x61, 0x74, 0x65,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x09, 0x2e, 0x52, 0x74, 0x63, 0x53, 0x74, 0x61, 0x74,
	0x65, 0x52, 0x08, 0x72, 0x74, 0x63, 0x53, 0x74, 0x61, 0x74, 0x65, 0x2a, 0x26, 0x0a, 0x0b, 0x52,
	...
	0x67, 0x10, 0x04, 0x42, 0x1a, 0x5a, 0x18, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x73, 0x2f, 0x70,
...
var file_commons_pbdefines_rtcroom_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
...
var file_commons_pbdefines_rtcroom_proto_goTypes = []interface{}{
	...
	(*RtcRoomReq)(nil),         // 3: RtcRoomReq
	(*RtcRoom)(nil),            // 4: RtcRoom
	(*RtcMember)(nil),          // 5: RtcMember
	(*MemberState)(nil),        // 6: MemberState
	(*SyncMemberStateReq)(nil), // 7: SyncMemberStateReq
	(*RtcRoomEvent)(nil),       // 8: RtcRoomEvent
	(*RtcInviteReq)(nil),       // 9: RtcInviteReq
	(*RtcMemberRooms)(nil),     // 10: RtcMemberRooms
	(*RtcMemberRoom)(nil),      // 11: RtcMemberRoom
...
var file_commons_pbdefines_rtcroom_proto_depIdxs = []int32{
	...
	5,  // 1: RtcRoomReq.joinMember:type_name -> RtcMember
	0,  // 2: RtcRoom.roomType:type_name -> RtcRoomType
	12, // 3: RtcRoom.owner:type_name -> UserInfo
	5,  // 4: RtcRoom.members:type_name -> RtcMember
	12, // 5: RtcMember.member:type_name -> UserInfo
	1,  // 6: RtcMember.rtcState:type_name -> RtcState
	12, // 7: RtcMember.inviter:type_name -> UserInfo
	0,  // 8: MemberState.roomType:type_name -> RtcRoomType
	1,  // 9: MemberState.rtcState:type_name -> RtcState
	6,  // 10: SyncMemberStateReq.member:type_name -> MemberState
	2,  // 11: RtcRoomEvent.roomEventType:type_name -> RtcRoomEventType
	5,  // 12: RtcRoomEvent.member:type_name -> RtcMember
	4,  // 13: RtcRoomEvent.room:type_name -> RtcRoom
	0,  // 14: RtcInviteReq.roomType:type_name -> RtcRoomType
	11, // 15: RtcMemberRooms.rooms:type_name -> RtcMemberRoom
	0,  // 16: RtcMemberRoom.roomType:type_name -> RtcRoomType
	12, // 17: RtcMemberRoom.owner:type_name -> UserInfo
	1,  // 18: RtcMemberRoom.rtcState:type_name -> RtcState
