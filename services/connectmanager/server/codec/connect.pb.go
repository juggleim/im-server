...
type ConnectAckMsgBody struct {
	...
	CleanMentionType int32                  `protobuf:"varint,8,opt,name=cleanMentionType,proto3" json:"cleanMentionType,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *ConnectAckMsgBody) GetCleanMentionType() int32 {
	if x != nil {
		return x.CleanMentionType
	}
	return 0
}
...
const file_connect_proto_rawDesc = "" +
	...
	"\tvoipToken\x18\x14 \x01(\tR\tvoipToken\"\xd7\x01\n" +
	...
	"\x04conf\x18\x06 \x01(\v2\f.ConnectConfR\x04conf\x12*\n" +
	"\x10cleanMentionType\x18\b \x01(\x05R\x10cleanMentionType\"\xb7\x01\n" +
	"\vConnectConf\x12,\n" +
