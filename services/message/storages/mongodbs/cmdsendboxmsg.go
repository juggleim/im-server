...
func (msg *CmdSendboxMsgDao) getCollection() *mongo.Collection {
	return mongocommons.GetCollection(msg.TableName())
}

func (msg *CmdSendboxMsgDao) IndexCreator() func(colName string) {
