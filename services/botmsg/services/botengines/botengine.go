...
func (engine *NilBotEngine) StreamChat(ctx context.Context, senderId, converId string, question string, f func(answerPart string, sectionStart, sectionEnd, isEnd bool)) {
}

func (engine *NilBotEngine) Chat(ctx context.Context, senderId, converId string, question string) string {
	return ""
}
