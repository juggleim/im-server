...
jq -r '
  ...
  "| Stars, last 24 hours | \(.github.primary_repository.star_growth.last_24h) |",
  "| Stars, last 7 days | \(.github.primary_repository.star_growth.last_7d) |",
  "| Stars, last 30 days | \(.github.primary_repository.star_growth.last_30d) |",
  "| GitHub Discussions | \(.github.primary_repository.campaign_activity.discussions.total) |",
  "| Discussion comments | \(.github.primary_repository.campaign_activity.discussions.comments_total) |",
